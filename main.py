...
class mianWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.ui.zeroButton_15.clicked.connect(lambda:pressionado("0"))
        ...
        self.ui.divisaoButton.clicked.connect(lambda:pressionado("/"))
        self.ui.multiplicacaoButton.clicked.connect(lambda:pressionado("*"))
        self.ui.somaButton.clicked.connect(lambda:pressionado("+"))
        self.ui.subtracaoButton.clicked.connect(lambda:pressionado("-"))
        self.ui.clearButton.clicked.connect(lambda:clearOutput())
        self.ui.blackspaceButton.clicked.connect(lambda:blackspace())
        self.ui.igualButton.clicked.connect(lambda:resultado())
        self.ui.porcentageButton.clicked.connect(lambda:resultado())
        ...
        def resultado():
            ...
            try:
                ...
                self.ui.outputLabel.setText("ERRRO")
